...
namespace MishiWeb.Areas.Identity.Pages.Account
{
     ...
     public RegisterModel(
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.FirtsName = Input.FirtsName;
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (role == SD.FornDeskRole)
                            {
                                await _userManager.AddToRoleAsync(user, SD.FornDeskRole);
                            }
                            else
                            {
